        ...
        <div className="card">
            <div className="card-body fs-7 text-secondary">
                <div className="d-flex mb-3">
                    ...
                    <div className="col-6">
                        <input className="form-control" placeholder="Britama SME" />
                    </div>
                </div>
                <div className="d-flex mb-3">
                    <div className="col-6 my-auto">
                    ...
                    <div className="col-6">
                        <input className="form-control" placeholder="B1" />
                    </div>
                </div>
                <div className="d-flex mb-3">
                    <div className="col-6 my-auto">
                    ...
                    <div className="col-6">
                        <input className="form-control" placeholder="BritAma" />
                    </div>
                </div>
                <div className="d-flex mb-3">
                    <div className="col-6 my-auto">
                    ...
                    <div className="col-6">
                        <input className="form-control" placeholder="S" />
                    </div>
                </div>
                <div className="d-flex mb-3">
                    <div className="col-6 my-auto">
                    ...
                    <div className="col-6">
                        <input className="form-control" placeholder="false" />
                    </div>
                </div>
                <div className="d-flex mb-3">
                    <div className="col-6 my-auto">
