            ...
            <div className="col-12 col-md-6">
                <div className="card">
                    <form onSubmit={handleSubmit}>
                        <div className="card-header p-3 bg-primary text-white">Search by User</div>
                        <div className="card-body text-secondary fs-7">
                            <div className="d-block d-sm-flex align-items-center mb-2">
                                <div className="col-sm-4 my-2 my-sm-0">User Type</div>
                                <div className="col-sm-8">
                                    <Select options={options} styles={style} />
                                </div>
                            </div>
                            <div className="d-block d-sm-flex align-items-center mb-2">
                                <div className="col-sm-4 my-2 my-sm-0">User</div>
                                <div className="col-sm-8">
                                    <Select options={options} styles={style} />
                                </div>
                            </div>
